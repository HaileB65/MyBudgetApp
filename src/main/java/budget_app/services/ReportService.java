...
public class ReportService {
    ...
    public static void runFutureBalanceReport(){
        System.out.println("FutureBalanceReport");
        // get sum of transactions from last month
        // print out current savings minus sum of transactions from last month
    }
    ...
    public static void RunSpendingVsSavingOverTimeReport(){
    ...
    public static void runComprehensiveFinancialSanityReport(){
        System.out.println("ComprehensiveFinancialSanityReport");
        //

    }

    public static void runGoalsReport(){
